 ...
 *
 * @RestResource(
 *   id = "generate_otp_resource",
 *   label = @Translation("Generate OTP"),
 *   uri_paths = {
 *     "canonical" = "/otp/generate",
 *     "https://www.drupal.org/link-relations/create" = "/otp/generate"
 *   }
 * )
 */
class OtpGenerateResource extends ResourceBase {
  ...
  public function post(array $user_input) {
    ...
    return new ResourceResponse($otp_service->generateOtp($user_input["mobile_number"]));
  }
