...
class FooTable extends Table {
  ...
  /**
   * Pre-render callback for FooTable elements.
   *
   * Adds the necessary CSS classes, attaches the FooTable library, and converts
   * element properties into HTML5 data attributes
   * required by the jQuery plugin.
   *
   * @param array $element
   *   An array containing the properties and children of the
   *   table element.
   *
   * @return array
   *   The modified render array with attached library and data attributes.
   */
